...
class YouTubeScraper:
    ...
    async def get_channel_info(self, channel_input: str, max_videos: int = 50) -> Optional[ChannelInfo]:
        try:
            ...
            with yt_dlp.YoutubeDL(self.ydl_opts) as ydl:
                ...
                channel_info = ChannelInfo(
                    ...
                    subscriber_count=self._safe_int(channel_data.get('subscriber_count')),
                    video_count=self._safe_int(channel_data.get('video_count')),
                    view_count=self._safe_int(channel_data.get('view_count')),
                    profile_picture_url=self._get_best_thumbnail(channel_data.get('thumbnails', [])),
    ...
    def _extract_video_info(self, video_data: Dict[str, Any]) -> Optional[VideoInfo]:
        try:
            ...
            return VideoInfo(
                ...
                thumbnail_url=self._get_best_thumbnail(video_data.get('thumbnails', []))
            )
        except Exception as e:
