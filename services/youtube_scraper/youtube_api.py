...
class YouTubeAPIClient:
    ...
    async def get_channel_by_handle(self, handle: str) -> Optional[str]:
        ...
        try:
            ...
            print(f"Error getting channel by handle {handle}: {str(e)}")
    ...
    async def get_channel_info(self, channel_id: str, max_videos: int = 50) -> Optional[ChannelInfo]:
        ...
        try:
            ...
            if isinstance(channel_response, Exception) or isinstance(videos_response, Exception):
                return None
