...
class VideoAnalyzer:
    ...
    def analyze_top_videos(self, videos: List[VideoInfo]) -> Dict:
        ...
        recent_analysis = [self._analyze_single_video(video, f"Recent #{i}") 
                          for i, video in enumerate(recent_videos, 1)]
        popular_analysis = [self._analyze_single_video(video, f"Popular #{i}") 
    ...
    def _analyze_single_video(self, video: VideoInfo, rank: str) -> Dict:
        ...
        return {
            ...
            "performance": {
                ...
                "comment_ratio": round((video.comment_count or 0) / max(video.view_count or 1, 1) * 1000, 2)
            },
    ...
    def _generate_video_insights(self, recent_videos: List[VideoInfo], popular_videos: List[VideoInfo]) -> Dict:
