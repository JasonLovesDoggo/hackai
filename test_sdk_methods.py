...
def test_sdk_methods():
    ...
    try:
        ...
        if hasattr(client, "index"):
            ...
            index_methods = [
                attr for attr in dir(client.index) if not attr.startswith("_")
            ]
        ...
        if hasattr(client, "task"):
            ...
            task_methods = [
                attr for attr in dir(client.task) if not attr.startswith("_")
            ]
        ...
        if hasattr(client, "video"):
            ...
            video_methods = [
                attr for attr in dir(client.video) if not attr.startswith("_")
            ]
        ...
        if hasattr(client, "understanding"):
            ...
            understanding_methods = [
                attr for attr in dir(client.understanding) if not attr.startswith("_")
            ]
